				...
				<div class="panel-body">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<button type="submit" id="submit" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span> {{ config($labels['create'] .'.create') }}</button>
						</div>
					</div>
					{!! Form::close() !!}
				</div>
