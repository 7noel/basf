...
class AdminTableSeeder extends Seeder {
    ...
    public function run()
    {
        ...
        User::create(['name' => 'ASE_001', 'email' => 'asesor_001@gmail.com', 'password' => '123', 'is_superuser' => false]);
        User::create(['name' => 'ASE_002', 'email' => 'asesor_002@gmail.com', 'password' => '123', 'is_superuser' => false]);
        User::create(['name' => 'ASE_003', 'email' => 'asesor_003@gmail.com', 'password' => '123', 'is_superuser' => false]);
        User::create(['name' => 'ASE_004', 'email' => 'asesor_004@gmail.com', 'password' => '123', 'is_superuser' => false]);

        $r=Role::create(['name' => 'ADMINISTRADOR DE SISTEMA']);
        $r->users()->sync([1]);
        $r=Role::create(['name' => 'MATIZADOR']);
        $r->users()->sync([2,3,4,5]);
        $r=Role::create(['name' => 'ASESOR']);
        $r->users()->sync([10,11,12,13]);
        $r=Role::create(['name' => 'PINTOR']);
        $r->users()->sync([6,7,8,9]);
        $r4=Role::create(['name' => 'ADMIN TALLER']);
        $r4=Role::create(['name' => 'ADMIN DISTRIBUIDOR']);
        $r4=Role::create(['name' => 'ADMIN PROVEEDOR']);
