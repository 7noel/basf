...
class Product extends Model implements Auditable {
	...
	protected $fillable = ['name', 'intern_code', 'provider_code', 'manufacturer_code', 'description', 'sub_category_id', 'unit_id', 'unit_dispatch_id', 'currency_id', 'country_id', 'brand_id', 'model', 'last_purchase', 'profit_margin', 'admin_expense', 'value', 'use_set_value', 'is_downloadable'];
